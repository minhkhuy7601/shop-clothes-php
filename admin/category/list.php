<?php
    ...
    while($item = mysqli_fetch_assoc($result)){
        $json[]=["category_id"=>$item['category_id'], "category_name"=>$item['category_name']];
    }
...
<div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="./index.php?menu=12&layout=add">Thêm mới</a>
        ...
        function renderData($json){
            ...
            $.each($json, function(index, value){
                ...
                $tbody.append(` <tr>
                                        ...
                                        <td><a href="./index.php?menu=12&layout=edit&id=${value['category_id']}"><button type="button" class="btn btn-success">Sửa</button></a></td>
                                    <td><a onclick="return del()" href="./index.php?menu=12&layout=del&id=${value['category_id']}"><button type="button" class="btn btn-danger">Xóa</button></a></td>
                                    </tr>
