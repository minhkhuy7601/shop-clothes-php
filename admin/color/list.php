<?php
    ...
    while($item = mysqli_fetch_assoc($result)){
        $json[]=["color_id"=>$item['color_id'], "color_name"=>$item['color_name']];
    }
...
<div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary" href="./index.php?menu=11&layout=add">Thêm mới</a>
        ...
        function renderData($json){
            ...
            $.each($json, function(index, value){
                ...
                $tbody.append(` <tr>
                                        ...
                                        <td><a href="./index.php?menu=11&layout=edit&id=${value['color_id']}"><button type="button" class="btn btn-success">Sửa</button></a></td>
                                    <td><a onclick="return del()" href="./index.php?menu=11&layout=del&id=${value['color_id']}"><button type="button" class="btn btn-danger">Xóa</button></a></td>
                                    </tr>
