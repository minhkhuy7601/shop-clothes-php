...
?>
    ...
    <div id="breadcumb-shop">
        <div class="container">
            <ul class="breadcumb">
                ...
                <li>
                    <a href="sale.php?sale=100">Sale</a>
                    <span>/</span>
                </li>
                <li>
        ...
        <div class="main-content container">
            <div class="col-2 h-xs h-tb" id="left-nav">
                ...
                <ul id="left-menu-site">
                    <li><a href="sale.php" id="all">Shop ALL</a></li>
                    <?php
                        $sql="SELECT * FROM category";
                        $result=mysqli_query($conn, $sql);
                        while($item = mysqli_fetch_assoc($result)){
                            ?>
                                 <li><a href="sale.php?category=<?php echo $item['category_id'] ?>" id="<?php echo $item['category_id'] ?>"><?php echo $item['category_name'] ?></a></li>
                            <?php
                        }
    ...
    <?php require_once 'controller/js/saleProduct.php'; ?>
