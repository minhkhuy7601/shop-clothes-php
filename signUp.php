...
<?php require_once 'view/header.php' ?>
    ...
    <section id="main" class="container">
        <form action="signUp.php" id="form-sign-up" class="col-6 col-tb-8 col-xs-12" method="POST">
            <h1>Tạo tài khoản</h1>
            <div class="form-control">
                <input type="text" placeholder="Họ tên" id="name" name="nameUser" value="<?php echo $nameUser;?>">
            ...
            <div class="form-control">
                <input type="text" placeholder="Số điện thoại" id="phone-number" name="phoneNumber" value="<?php echo $phoneNumber;?>">
                <i id="icon-error" class="bx bxs-error-circle"></i>
                <i id="icon-success" class="bx bxs-check-circle"></i>
                <br>
                <small>Error</small>
            </div>
            <!-- <div class="form-control<?php if(!empty($errorUsername)):?> error<?php endif ?>">
                <input type="text" placeholder="Tên đăng nhập" id="userName" name="username" value="<?php echo $username;?>">
                <i id="icon-error" class="bx bxs-error-circle"></i>
                <i id="icon-success" class="bx bxs-check-circle"></i>
                <small><?php echo $errorUsername;?></small>
            </div> -->
            <div class="form-control">
            ...
            <button type="submit" name="signup-btn">Đăng nhập</button>
            <a href="index.php"><i class="bx bxs-chevrons-left"></i> Quay lại trang chủ</a>
        </form>
    </section>
    <footer>
